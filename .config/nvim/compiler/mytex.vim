...
function! s:TexToggleLuaLaTeX() abort
...
" TexToggleLatexmk
nmap <leader>tl <Plug>TexToggleLuaLaTeX
nnoremap <script> <Plug>TexToggleLuaLaTeX <SID>TexToggleLuaLaTeX
nnoremap <SID>TexToggleLuaLaTeX :call <SID>TexToggleLuaLaTeX()<CR>
