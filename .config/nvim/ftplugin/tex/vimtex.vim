...
function! s:TexToggleShellEscape() abort
  if g:vimtex_compiler_lualatex.options[0] ==# '-shell-escape'
    " Disable shell escape
    call remove(g:vimtex_compiler_lualatex.options, 0)
  else
    " Enable shell escape
    call insert(g:vimtex_compiler_lualatex.options, '-shell-escape', 0)
  endif
  VimtexReload
  VimtexClean
endfunction
